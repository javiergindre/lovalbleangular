  ...
  tenants: [
    {
      ...
      settings: {
        theme: 'light',
        logo: './assets/images/tenants/premedic/logo.png',
        logo_mobile: './assets/images/tenants/premedic/logo_mobile.svg',
        favicon: './assets/images/tenants/premedic/favicon.ico',
        language: 'en',
        skinDev: false
      }
    },
